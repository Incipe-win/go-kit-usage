...
const (
	Trim_TrimSpace_FullMethodName = "/addsrv.Trim/TrimSpace"
)
...
// All implementations should embed UnimplementedTrimServer
// for forward compatibility.
type TrimServer interface {
	TrimSpace(context.Context, *TrimRequest) (*TrimResponse, error)
}

// UnimplementedTrimServer should be embedded to have
