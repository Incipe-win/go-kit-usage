...
const file_trim_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"trim.proto\x12\x06addsrv\"\x1b\n" +
	"\vTrimRequest\x12\f\n" +
	"\x01s\x18\x01 \x01(\tR\x01s\"\x1c\n" +
	"\fTrimResponse\x12\f\n" +
	"\x01s\x18\x01 \x01(\tR\x01s2>\n" +
	"\x04Trim\x126\n" +
	"\tTrimSpace\x12\x13.addsrv.TrimRequest\x1a\x14.addsrv.TrimResponseB^\n" +
	"\n" +
	"com.addsrvB\tTrimProtoP\x01Z\raddsrv3/proto\xa2\x02\x03AXX\xaa\x02\x06Addsrv\xca\x02\x06Addsrv\xe2\x02\x12Addsrv\\GPBMetadata\xea\x02\x06Addsrvb\x06proto3"
...
var file_trim_proto_goTypes = []any{
	(*TrimRequest)(nil),  // 0: addsrv.TrimRequest
	(*TrimResponse)(nil), // 1: addsrv.TrimResponse
}
var file_trim_proto_depIdxs = []int32{
	0, // 0: addsrv.Trim.TrimSpace:input_type -> addsrv.TrimRequest
	1, // 1: addsrv.Trim.TrimSpace:output_type -> addsrv.TrimResponse
