...
const (
	Add_Sum_FullMethodName    = "/addsrv.Add/Sum"
	Add_Concat_FullMethodName = "/addsrv.Add/Concat"
)
...
// All implementations should embed UnimplementedAddServer
...
// UnimplementedAddServer should be embedded to have
